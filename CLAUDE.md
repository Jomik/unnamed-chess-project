...
- **feedback.rs** — `compute_feedback`: pure function mapping (position, curr_sensors, reference_sensors) → per-square LED instructions. Recovery guidance is integrated as a fallback path.
